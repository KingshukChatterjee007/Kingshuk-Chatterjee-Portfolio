...
function Projects() {
    ...
    useEffect(() => {
        const curatedList = [
            {
                id: 'pinn',
                name: 'Dynamic Gradient Balancing PINNs',
                customDescription: 'A deep learning framework for solving partial differential equations with dynamic gradient balancing for stable training.',
                html_url: 'https://github.com/KingshukChatterjee007/Dynamic-Gradient-Balancing-Physics-Informed-Neural-Networks',
                language: 'Python',
                stargazers_count: 5,
                forks_count: 2,
                topics: ['PINN', 'Deep Learning', 'Physics', 'Optimization'],
                images: ['/projects/pinn.png'],
            },
            {
                id: 'krishi-sahyogi',
                name: 'Krishi Sahayogi',
            ...
            {
                id: 'ai-clot',
                name: 'AI-Clot-Monitoring',
                customDescription: 'AI integration in wearables for real-time blood clot risk assessment and health monitoring using sensor data.',
                html_url: 'https://github.com/KingshukChatterjee007/AI-Integration-in-Wearables-for-Clot-Monitoring',
                language: 'Embedded AI',
                stargazers_count: 12,
                forks_count: 3,
                topics: ['Healthcare', 'Sensors', 'Real-time', 'MedTech'],
                images: ['/projects/aiclot.png'],
            },
            {
                id: 'sys-logger',
                name: 'Sys Logger',
                customDescription: 'System logging platform with advanced frontend architecture and responsive dashboards for enterprise monitoring.',
            ...
            },
            {
                ...
                customDescription: 'Computer vision project for identifying road damage using advanced object detection models like YOLO.',
            ...
            },
            {
                ...
                customDescription: 'Advanced derivatives pricing engine using quantitative financial models and risk analysis framework.',
                html_url: '#contact',
                isPrivate: true,
                language: 'C++/Python',
            ...
            },
            {
                id: 'camtrak',
                name: 'CamTrak',
                customDescription: 'Gesture-based Windows control system utilizing hand-tracking for intuitive and touchless OS interaction.',
                html_url: 'https://github.com/KingshukChatterjee007/CamTrak',
                language: 'Python',
                stargazers_count: 9,
                forks_count: 1,
                topics: ['Computer Vision', 'Gestures', 'Automation', 'Human-Computer Interaction'],
                images: ['/projects/camtrak.png'],
            },
            {
                id: 'krown-frame',
                name: 'KrownFrame',
